    ...
    <div class="d-flex">
        ...
        <div class="content p-1">
            <div class="list-group-item">
                ...
                $resul_user = "SELECT user.id, user.nome, user.email, nivac.nome nome_nivac
                                ...
                                <?php
                                 while ($row_user = mysqli_fetch_assoc($resultado_user)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-lg-table-cell"><?php echo $row_user['nome_nivac']; ?></td>
                                        <td class="text-center">
                                            <span class="d-none d-md-block">
                                                <?php
                                                $btn_vis = carregar_btnd('visualizar/vis_usuario', $conn);
                                                if ($btn_vis) {
                                                    echo "<a href='" . pg . "/visualizar/vis_usuario?id=" . $row_user['id'] . "' class='btn btn-outline-primary btn-sm'>Visualizar</a> ";
                                                }
                                                $btn_edit = carregar_btnd('editar/edit_usuario', $conn);
                                                if ($btn_edit) {
                                                    echo "<a href='" . pg . "/editar/edit_usuario?id=" . $row_user['id'] . "' class='btn btn-outline-warning btn-sm'>Editar</a> ";
                                                }
                                                $btn_apagar = carregar_btnd('processa/apagar_usuario', $conn);
                                                if ($btn_apagar) {
                                                    echo "<a href='" . pg . "/processa/apagar_usuario?id=" . $row_user['id'] . "' class='btn btn-outline-danger btn-sm'>Apagar</a> ";
                                                }
                                                ?>
                                            </span>
                                            <div class="dropdown d-block d-md-none">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                                    ...
                                                    if ($btn_apagar) {
                                                        echo "<a class='dropdown-item' href='" . pg . "/ptocessa/apagar_usuario?id=" . $row_user['id'] . "'>Apagar</a>";
                                                    }                                                 
                                                    ?>                                                                                                        
