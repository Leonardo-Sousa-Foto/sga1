...
if (SendEditNivAc) {
    ...
    if (!$dados_validos) {
        $erro = true;
        $_SESSION['msg'] = "<div class='alert alert-danger'>Necessário preencher todos os campos para editar o nível de acesso!</div>";
    }
    ...
    if ($erro) {
        ...
        if (mysqli_affected_rows($conn)) {
            $_SESSION['msg'] = "<div class='alert alert-success'>Editado com sucesso!<button type='button' class='close' data-dismiss='alert' aria-label='Close'>
