...
//var_dump($dados);
//Validar nunhum campo vazio
    $erro = false;
    include 'lib/lib_vazio.php';
...
//Houve um erro em algum campo e será redicionado para o formulário, não há erro no formulário tenta cadastrar no banco
    if ($erro) {
